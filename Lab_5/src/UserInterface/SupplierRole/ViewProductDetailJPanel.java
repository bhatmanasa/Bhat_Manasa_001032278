...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
   ...
   if(txtName.getText().equals("") || txtPrice.getText().equals("")){
         JOptionPane.showMessageDialog(null, "Product Name and Price are mandatory to be filled!", "Warning", JOptionPane.INFORMATION_MESSAGE);            
         return;           
        }
   try{
        product.setPrice(Integer.parseInt(txtPrice.getText()));
           }catch(Exception e){
           JOptionPane.showMessageDialog(null, "Price needs to be numbers only!", "Warning", JOptionPane.INFORMATION_MESSAGE);                 
           return;
           }
