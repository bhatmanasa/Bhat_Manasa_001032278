...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(txtName.getText().equals("") || txtAvailability.getText().equalsIgnoreCase("") || txtPrice.getText().equals("")){
        ...
        JOptionPane.showMessageDialog(null, "Availability can be numbers only!", "Info", JOptionPane.INFORMATION_MESSAGE);            
        return;
        }
            ...
            JOptionPane.showMessageDialog(null, "Price needs to be in digits only!", "Info", JOptionPane.INFORMATION_MESSAGE);                        
            return;
            }
        ...
        if(stringPrice.isEmpty()==false){
             ...
             p.setPrice(Integer.parseInt(stringPrice));
