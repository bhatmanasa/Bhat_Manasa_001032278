...
public class AddSupplier extends javax.swing.JPanel {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Please enter new supplier Name!!", "Info", JOptionPane.INFORMATION_MESSAGE);
        return;
        }
        for(Supplier s: supplierDirectory.getSupplierlist()){
            if(txtName.getText().equalsIgnoreCase(s.getSupplyName())){
             JOptionPane.showMessageDialog(null, "Supplier already present!!", "Info", JOptionPane.INFORMATION_MESSAGE); 
             return;
            }
        }
