...
public class BrowseProducts extends javax.swing.JPanel {
    ...
    private void viewProdjButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewProdjButton2ActionPerformed
        ...
        upc.add("ViewProductDetailJPanelCustomer", vpdjp);
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
        ...
        if(salesPrice <= selectedProduct.getPrice()){
                  JOptionPane.showMessageDialog(null, "Sales Price cannot be less than the actual price!", "Warning", JOptionPane.WARNING_MESSAGE);   
                  return;
        }
        if(fetchQty <= selectedProduct.getAvail()){
            ...
            if(!alreadyPresent){
                 ...
                 JOptionPane.showMessageDialog(null, "Quantity entered is greater than the Availability", "Warning", JOptionPane.WARNING_MESSAGE);   
            
        }
        }catch(Exception e){
                 JOptionPane.showMessageDialog(null, "Invalid Sales price!", "Warning", JOptionPane.WARNING_MESSAGE);   
                 return;
        }
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if(newQty <= 0){
                JOptionPane.showMessageDialog(null, "Quantity cannot be less than or eual to zero!", "Warning", JOptionPane.WARNING_MESSAGE);               
                 return;           
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        upc.add("ViewProductDetailJPanelOrder", vpdjp);
        CardLayout layout = (CardLayout) upc.getLayout();
        layout.next(upc);         
